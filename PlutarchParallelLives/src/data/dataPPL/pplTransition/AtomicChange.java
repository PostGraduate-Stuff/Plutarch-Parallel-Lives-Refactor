...
public class AtomicChange {
	...
	public AtomicChange(String tmpAffectedTable, String tmpAffectedAttribute, String tmpType, String tmpOldSchema, String tmpNewSchema,Integer transitionID){
		...
		this.affectedAttribute = tmpAffectedAttribute;
		this.type = tmpType;
		this.oldSchema = tmpOldSchema;
		this.newSchema = tmpNewSchema;
		this.transitionID = transitionID;
	}
	
	public String toString(){
		return "AtomicChange: Table: "+affectedTable+"\tAttribute: "+affectedAttribute+"\tType: "+type+"\toldSchema: "+ oldSchema +"\tnewSchema: " +newSchema;
	}
